...
public class MainActivity extends AppCompatActivity implements UsersListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.userfeedback){
            ...
            builder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Log.i("Info",feedbackEditText.getText().toString());
                    database.getReference().child("userfeedback").push().setValue(feedbackEditText.getText().toString());
                    Toast.makeText(MainActivity.this,"Your response is saved succesfully",Toast.LENGTH_SHORT).show();
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(preferenceManager.getString(Constants.KEY_FULL_NAME));
    ...
    public boolean isUserVerified (FirebaseUser user) {
        ...
        user.reload();
        if (user.isEmailVerified() && isInContect()) {
            return true;
        } else {
